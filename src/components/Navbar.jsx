            ...
            <nav className="border-gray-200 bg-zinc-900 mb-16">
                <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
                    ...
                    <ul className="font-medium flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 bg-gray-800 md:bg-gray-900 border-gray-700">
                        <li>
                            <Link to={"/"}><a className="block py-2 px-3 text-white rounded md:bg-transparent md:p-0 text-zinc-100" aria-current="page">Home</a></Link>
                        </li>
                    
                        <li>
                            <Link to={"/list"}><a className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:p-0 text-white hover:text-zinc-300">List</a></Link>
                        </li>
                    </ul>
                    </div>
                </div>
